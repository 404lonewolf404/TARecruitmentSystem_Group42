            ...
            <form action="<%= request.getContextPath() %>/auth/register" method="post" class="register-form">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role" required>
                        ...
                        <option value="MO" <%= "MO".equals(request.getParameter("role")) ? "selected" : "" %>>模块负责�?(MO)</option>
                        <option value="ADMIN" <%= "ADMIN".equals(request.getParameter("role")) ? "selected" : "" %>>管理�?(Admin)</option>
                    </select>
                </div>
